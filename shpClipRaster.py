...
if __name__ == "__main__":
    ...
    parser.add_argument('--image', type=str, default=r"D:\咸鱼\研究区DEM3.tif", help='image path')
    parser.add_argument('--shape', type=str, default=r"D:\downloads\研究区\中国边界矢量\中国边界.shp", help='ESRI shapefile path')
    parser.add_argument('--output', type=str, default=r"D:\downloads\研究区\xiaotu", help='output_raster path')
    opt = parser.parse_args()
    start = time.time()
    # shapeList = glob.glob(os.path.join(opt.shape, "*.shp"))
    shapeList= [r"D:\咸鱼\矢量\01.shp"]
